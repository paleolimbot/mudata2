...
vignette: >
  %\VignetteIndexEntry{mudata_subset}
...
- See what it contains using `summary()`, `print()`, `autoplot()`, `distinct_locations()`, and `distinct_params()`
...
```{r autoplot, warning = FALSE, fig.width=7, fig.height=5}
autoplot(ns_climate)
```
